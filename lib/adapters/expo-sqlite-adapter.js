...
// Import base adapter from ShareDB
var BaseSqliteAdapter = ShareDB.BaseSqliteAdapter || require('@shaxpir/sharedb/lib/client/storage/adapters/base-sqlite-adapter');
...
ExpoSqliteAdapter.prototype.run = function(sql, params, callback) {
  ...
  this.db.runAsync(sql, params || []).then(function(result) {
    adapter.debug && logger.info('Executed SQL: ' + sql.substring(0, 50));
